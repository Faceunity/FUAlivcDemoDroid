package com.alivc.live.pusher.demo.custom;
...
import com.alivc.live.pusher.demo.custom.profile.CSVUtils;
import com.alivc.live.pusher.demo.custom.profile.Constant;
...
public class CameraRenderer implements Camera.PreviewCallback {
    ...
    private int mSkippedFrames = 10;
    private FURenderer mFURenderer;
    private CSVUtils mCSVUtils;
    private AlivcLivePusher mLivePusher;

    public CameraRenderer(Activity activity, FURenderer.OnDebugListener listener, AlivcLivePusher livePusher) {
        mActivity = activity;
    ...
    private void openCamera(int cameraFacing) {
        try {
            ...
            CameraUtils.chooseFramerate(parameters, 30000);
