...
FUAlivcDemoDroid 是集成了 Faceunity 面部跟踪和虚拟道具功能 和 阿里推流 的 Demo。

本文是 FaceUnity SDK 快速对阿里推流的导读说明，关于 `FaceUnity SDK` 的详细说明，请参看 **[FULiveDemoDroid](https://github.com/Faceunity/FULiveDemoDroid/tree/dev)**
...
```
            ...
            public int customFilterProcess(int inputTexture, int textureWidth, int textureHeight, long extra) {
                return mFURenderer.onDrawFrame(inputTexture, textureWidth, textureHeight);
            }
```
